...
SELECT 'Thati', 23, P.plano_id , '2019-10-20'
FROM SpotifyClone.plano P
WHERE plano_id = 1;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Cintia', 35, P.plano_id, '2017-12-30'
FROM SpotifyClone.plano P
WHERE plano_id = 2;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Bill', 20, P.plano_id, '2019-06-05'
FROM SpotifyClone.plano P
WHERE plano_id = 3;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Roger', 45, P.plano_id, '2020-05-13'
FROM SpotifyClone.plano P
WHERE plano_id = 4;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Norman', 58, P.plano_id, '2017-02-17'
FROM SpotifyClone.plano P
WHERE plano_id = 4;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Patrick', 33, P.plano_id, '2017-01-06'
FROM SpotifyClone.plano P
WHERE plano_id = 2;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Vivian', 26, P.plano_id, '2018-01-05'
FROM SpotifyClone.plano P
WHERE plano_id = 3;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Carol', 19, P.plano_id, '2018-02-14'
FROM SpotifyClone.plano P
WHERE plano_id = 3;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Angelina', 42, P.plano_id, '2018-04-29'
FROM SpotifyClone.plano P
WHERE plano_id = 2;

INSERT INTO SpotifyClone.usuario (usuario, idade, plano_id, data_assinatura)
SELECT 'Paul', 46, P.plano_id, '2017-01-17'
FROM SpotifyClone.plano P
WHERE plano_id = 2;
...
INSERT INTO SpotifyClone.seguindo_artistas (usuario_id, seguindo_artistas)
VALUES
(1, 1),
(1,	4),
(1,	3),
